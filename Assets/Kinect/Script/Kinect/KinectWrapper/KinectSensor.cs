...
public class KinectSensor : MonoBehaviour, KinectInterface {
	...
	public static bool B_KINECT_IS_INITIALIZED = true;  //This variable is for the server (PC)
	...
	void Awake()
	{
		...
		try
		{
			...
			// HE Huilong , calculate local center and look at vectors from CommonVars
			/*
			sensorHeight = CommonVars.V3_KINECT_POSITION.y;
			kinectCenter.x = 0f;
			kinectCenter.y = 0f;
			kinectCenter.z = Mathf.Sqrt(CommonVars.V3_KINECT_POSITION.x * CommonVars.V3_KINECT_POSITION.x + CommonVars.V3_KINECT_POSITION.z * CommonVars.V3_KINECT_POSITION.z);
			lookAt = CommonVars.V3_KINECT_LOOKAT - CommonVars.V3_KINECT_POSITION;
			*/
			...
			NativeMethods.NuiCameraSetAngle(0);
